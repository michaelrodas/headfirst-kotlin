...
data class Duck(val size: Int = 10)
...
fun main(args: Array<String>) {
    ...
    println(mRecipeMap["Recipe2"])//Equivalent to get

    println(setOf(Duck(10), Duck()).size) //Rejects duplicate item

    val x = mutableSetOf(1, 2)
    val y: Set<Int> = x //Makes x immutable, it's the same object
    val z = x.toSet() //creates a copy
}